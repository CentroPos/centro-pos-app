...
import { CategoryTabs } from '../picking/CategoryTabs';
import { ItemsTable } from '../picking/ItemsTable';
import { RightSidebar } from '../picking/RightSidebar';
import { OpenInvoiceModal } from '../picking/OpenInvoiceModal';
import { AssignPickSlipModal } from '../picking/AssignPickSlipModal';
import { OrderScheduleModal } from '../picking/OrderScheduleModal';
...
const DynamicPickupInterface: React.FC = () => {
  ...
  return (
    <div className="h-full w-full flex bg-gray-50 overflow-hidden relative">
      ...
      {/* Right Sidebar - starts from top of window */}
